...
def main() -> int:
    ...
    checks = [
        ...
        ('Package == "server"' in iss and "Coalesce Server is installed" in iss, "server finished copy"),
        ('Package == "client"' in iss and "Coalesce Client is installed" in iss, "client finished copy"),
    ]
