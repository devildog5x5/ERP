...
def main() -> int:
    ...
    checks = [
        ...
        ("MinVersion=10.0" in server and "MinVersion=10.0" in client and "MinVersion=10.0" in chooser, "Win10+ gate"),
        ...
        ('Name: "full"' in chooser and 'Name: "server"' in chooser and 'Name: "client"' in chooser, "silent /TYPE= support"),
    ]
    ...
    for needle in ("server.iss", "client.iss", "ledgerly.iss", "LedgerlyServerSetup", "LedgerlyClientSetup", "LedgerlySetup"):
