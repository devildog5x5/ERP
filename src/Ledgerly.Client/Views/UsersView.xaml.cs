...
public partial class UsersView : UserControl
{
    ...
    private async void ResetPassword_Click(object sender, RoutedEventArgs e)
    {
        ...
        {
            MessageBox.Show("Select a user first.", "Coalesce", MessageBoxButton.OK, MessageBoxImage.Information);
            return;
        }
        ...
        {
            MessageBox.Show("Password must be at least 4 characters.", "Coalesce",
                MessageBoxButton.OK, MessageBoxImage.Warning);
            return;
        }
        ...
        try
        {
            ...
            MessageBox.Show($"Password reset for {selected.UserName}.", "Coalesce",
    ...
    private async void Delete_Click(object sender, RoutedEventArgs e)
    {
        ...
        {
            MessageBox.Show("You cannot delete your own account while signed in.", "Coalesce",
                MessageBoxButton.OK, MessageBoxImage.Warning);
            return;
        }
