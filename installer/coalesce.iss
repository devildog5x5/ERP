...
begin
  ...
  RoleIntro.Caption :=
    ...
    'CHOOSE ONE card. Read Includes / Skips. ✓ SELECTED is what installs. Next says Yes — Install…';
  ...
  RoleBoth.Caption := 'BOTH  —  Server + Client (full Coalesce on this PC)';
  ...
  RoleServer.Caption := 'SERVER ONLY  —  holds the data and API (no Client)';
  ...
  RoleClient.Caption := 'CLIENT ONLY  —  the desk you work at (no Server here)';
