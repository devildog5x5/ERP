...
begin
  ...
  RoleIntro.Caption :=
    ...
    'CHOOSE ONE card. Each shows Includes / Skips. ✓ SELECTED + Next = Yes — Install…';
  ...
  RoleHintBoth.Caption :=
    ...
    'Pick if: this is your only Coalesce PC.';
  ...
  RoleHintServer.Caption :=
    ...
    'Pick if: this box holds the books; other PCs connect here.';
  ...
  RoleHintClient.Caption :=
    ...
    'Pick if: Server already runs elsewhere — this PC is only a desk.';
