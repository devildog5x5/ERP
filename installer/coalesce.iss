...
begin
  ...
  RoleIntro.Caption :=
    'CHOOSE ONE. Big numbers 1 / 2 / 3 match the keys. Active card = ✓ SELECTED; others = Click to choose.'#13#10 +
    'Read each “Pick if …” line. Next turns into Yes — Install Both / Server / Client →';
  ...
  RoleFoot.Caption :=
    'Tip: click a card, press 1–3, or use the arrows — then Yes — Install… / Enter / Space (or double-click).'#13#10 +
    'Wrong download? Dedicated CoalesceServerSetup.exe / CoalesceClientSetup.exe skip this screen and ship a smaller payload.';
