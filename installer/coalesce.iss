...
begin
  ...
  RoleIntro.Caption :=
    ...
    'CHOOSE ONE card below. Each card lists Includes / Skips. Active card = ✓ SELECTED. Next = Yes — Install…';
  ...
  RoleBoth.Caption := 'BOTH  —  Server + Client (everything on this PC)';
  ...
  RoleServer.Caption := 'SERVER ONLY  —  holds the data (no Client)';
