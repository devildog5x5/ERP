...
**Combined** skips Welcome and InfoBefore so the three numbered option cards are the first screen. Selected card sinks and highlights; Next becomes Install Both → / Install Server → / Install Client →. Click, press 1 / 2 / 3, use ↑ ↓, or double-click to continue. Silent: `/TYPE=full|server|client`.
