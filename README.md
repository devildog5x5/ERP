...
|---------|------------------|----------|
| **Combined (chooser)** | One wizard — pick **Both**, **Server**, or **Client** (big clear radios) | [CoalesceSetup.exe](https://github.com/devildog5x5/ERP/releases/download/v1.6.15/CoalesceSetup.exe) |
| **Client only** | Desktop UI only (connects to a running Coalesce Server) | [CoalesceClientSetup.exe](https://github.com/devildog5x5/ERP/releases/download/v1.6.15/CoalesceClientSetup.exe) |
...
- Latest published binaries: [v1.6.15](https://github.com/devildog5x5/ERP/releases/tag/v1.6.15) (installer sources on this branch target **v1.6.16** — rebuild on Windows to publish)
- **CoalesceSetup.exe** asks up front — loudly — whether to install **Both**, **Server**, or **Client**. Hint text is clickable; silent installs use `/TYPE=full|server|client`.
- **Client** / **Server** packages install that role only (no chooser).
