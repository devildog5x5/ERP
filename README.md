...
|---------|------------------|----------|
| **Combined (chooser)** | One wizard — pick **Both**, **Server**, or **Client** | [CoalesceSetup.exe](https://github.com/devildog5x5/ERP/releases/download/v1.6.26/CoalesceSetup.exe) |
| **Client only** | Desktop UI only (talks to a running Coalesce Server) | [CoalesceClientSetup.exe](https://github.com/devildog5x5/ERP/releases/download/v1.6.26/CoalesceClientSetup.exe) |
| **Server only** | API / database host only | [CoalesceServerSetup.exe](https://github.com/devildog5x5/ERP/releases/download/v1.6.26/CoalesceServerSetup.exe) |

- Latest release: [v1.6.26](https://github.com/devildog5x5/ERP/releases/tag/v1.6.26)
